...
import com.joeyism.app.security.*;
import com.joeyism.app.web.filter.CsrfCookieGeneratorFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/getticker").permitAll()
            .antMatchers("/api/getticker/**").permitAll()
            .antMatchers("/api/submitstocks").permitAll()
